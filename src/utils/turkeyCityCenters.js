// Backend tarafında şehir merkezleri için basit bir harita.
// Not: Gerçek “ilan sınırı haritası” için polygon/geojson gerekir; burada sadece depo başlangıç koordinatı hedeflenir.

const TURKEY_CITY_CENTERS = {
...
function getCityCenter(city) {
  return TURKEY_CITY_CENTERS[city] || TURKEY_CITY_CENTERS['Adana'];
}

module.exports = { TURKEY_CITY_CENTERS, getCityCenter };
